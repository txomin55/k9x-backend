...
class DeleteStageServiceCaseTest {
    ...
    @BeforeEach
    void setUp() {
        serviceCase = new DeleteStageServiceCase(getStagePersistencePort, getCompetitionPersistencePort, deleteStagePersistencePort);
    }
    ...
    void throws_exception_when_user_is_not_organizer() {
        ...
        verifyNoInteractions(getStagePersistencePort, getCompetitionPersistencePort, deleteStagePersistencePort);
    }
    ...
    @Test
    void deletes_stage_when_all_validations_pass() {
        Stage stage = new Stage("stage-1", "Stage 1", "comp-1", "user-1", 0L, 0L, null);
