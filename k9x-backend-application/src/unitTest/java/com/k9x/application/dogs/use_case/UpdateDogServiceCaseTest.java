...
class UpdateDogServiceCaseTest {
    ...
    void throws_exception_when_dog_not_found() {
        ...
        assertThatThrownBy(() -> serviceCase.updateDog("dog-1", new UpdateDogCommand("Rex", "img", "Lab", "id", "user-1", "handler-1", "team", "ES"), "user-1", false))
    ...
    void throws_exception_when_dog_is_deleted() {
        Dog dog = new Dog("dog-1", "id", "breed", "Rex", "img", "user-1", "handler-1", "creator-1", "ES", "team", 0L, 0L, 1700000000000L);
    ...
    void throws_exception_when_owner_does_not_match_user() {
        ...
        assertThatThrownBy(() -> serviceCase.updateDog("dog-1", new UpdateDogCommand("Rex", "img", "Lab", "id", "user-1", "handler-1", "team", "ES"), "user-1", true))
    ...
    void throws_exception_when_no_owner_and_not_organizer() {
        ...
        assertThatThrownBy(() -> serviceCase.updateDog("dog-1", new UpdateDogCommand("Rex", "img", "Lab", "id", null, "handler-1", "team", "ES"), "creator-1", false))
                .isInstanceOf(UnauthorizedResourceException.class);
    ...
    void throws_exception_when_no_owner_and_user_is_not_creator() {
        ...
        assertThatThrownBy(() -> serviceCase.updateDog("dog-1", new UpdateDogCommand("Rex", "img", "Lab", "id", null, "handler-1", "team", "ES"), "user-1", true))
                .isInstanceOf(UnauthorizedResourceException.class);
    ...
    void updates_dog_by_owner_when_all_validations_pass() {
        ...
        serviceCase.updateDog("dog-1", new UpdateDogCommand("NewName", "img", "Lab", "id", "user-1", "handler-1", "team", "ES"), "user-1", false);
    ...
    void updates_dog_by_organizer_creator_when_no_owner() {
        ...
        serviceCase.updateDog("dog-1", new UpdateDogCommand("NewName", "img", "Lab", "id", null, "handler-1", "team", "ES"), "user-1", true);
