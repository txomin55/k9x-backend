...
class DeleteEventServiceCaseTest {
    ...
    @BeforeEach
    void setUp() {
        serviceCase = new DeleteEventServiceCase(getCompetitionPersistencePort, saveCompetitionPersistencePort);
    }

    private CompetitionSnapshot competitionWithEvent() {
    ...
    void saves_aggregate_when_all_validations_pass() {
        ...
        when(getCompetitionPersistencePort.getCompetition("comp-1")).thenReturn(competitionWithEvent());
