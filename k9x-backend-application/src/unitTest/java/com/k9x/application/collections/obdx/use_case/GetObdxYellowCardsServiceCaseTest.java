...
class GetObdxYellowCardsServiceCaseTest {
    ...
    void returns_yellow_cards_from_persistence() {
        List<FetchObdxYellowCardDTO> yellowCards = List.of(
                new FetchObdxYellowCardDTO("OBDX.FCI_GRADE_3.1_V2022", "judge-1", "Judge One", 1000L),
                new FetchObdxYellowCardDTO("OBDX.FCI_GRADE_3.1_V2022", "judge-1", "Judge One", 2000L));
