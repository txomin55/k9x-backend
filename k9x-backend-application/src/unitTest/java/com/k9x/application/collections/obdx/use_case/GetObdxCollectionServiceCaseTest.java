...
class GetObdxCollectionServiceCaseTest {
    ...
    void groups_scores_by_competitor_and_exercise() {
        ...
        List<FetchCollectionCompetitorDTO> competitors = List.of(
                new FetchCollectionCompetitorDTO("dog-1", "Rex", "ID-001", "Border Collie", "owner@test.com", "Handler", "Team A", "ES", (short) 1, null, true, false, null, null, "CART-1", null, true)
        );
        List<FetchCollectionExerciseDTO> exercises = List.of(
                new FetchCollectionExerciseDTO("ex-1", (short) 1, List.of("judge-1", "judge-2")));
    ...
    @Test
    void returns_only_exercises_assigned_to_the_visible_judges() {
        List<FetchCollectionJudgeWithCollectorDTO> visibleJudges = List.of(
        ...
        List<FetchCollectionExerciseDTO> exercises = List.of(
                new FetchCollectionExerciseDTO("ex-1", (short) 1, List.of("judge-1")),
                new FetchCollectionExerciseDTO("ex-2", (short) 2, List.of("judge-2"))
        );
        when(getObdxCollectionCompetitorsPersistencePort.getCompetitors("event-1")).thenReturn(competitors);
        when(getObdxCollectionExercisesPersistencePort.getExercises("event-1")).thenReturn(exercises);
        ...
        assertThat(result.competitors().getFirst().exercises())
                .extracting(com.k9x.application.collections.obdx.use_case.dto.FetchCollectionExerciseScoresDTO::exerciseId)
                .containsExactly("ex-1");
    }
    ...
    void sets_not_competing_status_on_competitors() {
        ...
        List<FetchCollectionCompetitorDTO> rawCompetitors = List.of(
                new FetchCollectionCompetitorDTO("dog-1", "Rex", "ID-001", "Border Collie", "owner@test.com", "Handler", "Team A", "ES", (short) 1, null, true, true, null, null, "CART-1", null, false)
        );
        when(getObdxCollectionCompetitorsPersistencePort.getCompetitors("event-1")).thenReturn(rawCompetitors);
        when(getObdxCollectionExercisesPersistencePort.getExercises("event-1")).thenReturn(List.of());
        when(getObdxCollectionScoresPersistencePort.getScores("event-1")).thenReturn(List.of());
    ...
    void sets_pending_enroll_accept_status_when_not_verified() {
        ...
        List<FetchCollectionCompetitorDTO> rawCompetitors = List.of(
                new FetchCollectionCompetitorDTO("dog-1", "Rex", "ID-001", "Border Collie", "owner@test.com", "Handler", "Team A", "ES", (short) 1, null, false, false, null, null, "CART-1", null, true)
        );
        when(getObdxCollectionCompetitorsPersistencePort.getCompetitors("event-1")).thenReturn(rawCompetitors);
        when(getObdxCollectionExercisesPersistencePort.getExercises("event-1")).thenReturn(List.of());
        when(getObdxCollectionScoresPersistencePort.getScores("event-1")).thenReturn(List.of());
    ...
    void disallows_scores_when_competitor_is_not_competing() {
        ...
        List<FetchCollectionCompetitorDTO> rawCompetitors = List.of(
                new FetchCollectionCompetitorDTO("dog-1", "Rex", "ID-001", "Border Collie", "owner@test.com", "Handler", "Team A", "ES", (short) 1, null, true, true, null, null, "CART-1", null, true)
        );
        when(getObdxCollectionCompetitorsPersistencePort.getCompetitors("event-1")).thenReturn(rawCompetitors);
        when(getObdxCollectionExercisesPersistencePort.getExercises("event-1")).thenReturn(List.of());
        when(getObdxCollectionScoresPersistencePort.getScores("event-1")).thenReturn(List.of());
