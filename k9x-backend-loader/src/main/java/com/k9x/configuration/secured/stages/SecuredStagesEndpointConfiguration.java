...
import com.k9x.infrastructure.in.rest.endpoints.secured.stages.CreateStageNotifications;
...
public class SecuredStagesEndpointConfiguration {
    ...
    @Bean
    public CreateStageNotifications createStageNotifications(
            CreateStageNotificationsServiceCase createStageNotificationsServiceCase, UserInfoDTO userInfoDTO) {
        return new CreateStageNotifications(createStageNotificationsServiceCase, userInfoDTO);
    }
}
