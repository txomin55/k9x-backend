...
class CreateObdxEventJooqAdapterTest {
    ...
    void generates_insert_sql_with_all_fields() {
        ...
        new CreateObdxEventJooqAdapter(dsl).createEvent("event-1", "Event 1", "stage-1", "user-1", createdAt);

        assertThat(capturedSql.get())
                .contains("insert into \"obdx\".\"events\"")
                .contains("\"id\"")
                .contains("\"name\"")
                .contains("\"stage_id\"")
                .contains("\"creator\"")
        ...
        assertThat(capturedBindings.get()).contains("event-1", "Event 1", "stage-1", "user-1", createdAt);
    }
}
