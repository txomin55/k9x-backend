...
import static com.k9x.infrastructure.out.postgres.jooq.generated.k9x.Tables.DOG_RANK;
...
class GetDogRankHistoryJooqAdapterTest {
    ...
    private DSLContext dslReturning(Object[]... rows) {
        MockDataProvider provider = ctx -> {
            sqls.add(ctx.sql());
            Field<?>[] fields = {DOG_RANK.DOG_ID, DOG_RANK.RANK, DOG_RANK.TIMESTAMP};
