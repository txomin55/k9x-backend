...
class GetObdxClassificationJooqAdapterTest {
    ...
    void generates_sql_with_correct_joins_where_and_order() {
        ...
        new GetObdxClassificationJooqAdapter(dsl).getClassification("evt-1");
    ...
    void returns_empty_list_when_no_competitors() {
        ...
        DSLContext dsl = DSL.using(new MockConnection(provider), SQLDialect.POSTGRES);
        List<FetchClassificationRawRowDTO> result = new GetObdxClassificationJooqAdapter(dsl).getClassification("evt-1");
    ...
    void maps_row_to_fetch_classification_raw_row_dto() {
        ...
        DSLContext dsl = DSL.using(new MockConnection(provider), SQLDialect.POSTGRES);
        List<FetchClassificationRawRowDTO> rows = new GetObdxClassificationJooqAdapter(dsl).getClassification("evt-1");
