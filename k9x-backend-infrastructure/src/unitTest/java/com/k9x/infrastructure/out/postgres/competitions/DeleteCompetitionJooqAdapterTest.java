...
class DeleteCompetitionJooqAdapterTest {
    ...
    void generates_update_sql_setting_deleted_at_filtered_by_id() {
        ...
        new DeleteCompetitionJooqAdapter(dsl).deleteCompetition("comp-123", deletedAt);
        ...
        assertThat(capturedBindings.get()[1]).isEqualTo("comp-123");
    }
}
