...
VALUES -- Classe 1 -> event_1783770421009
       ...
       ('event_1783770452508', '380260102376914', 1, 6, TRUE, FLOOR(EXTRACT(EPOCH FROM now()) * 1000), FALSE, FALSE, 653.89),
       ('event_1783770452508', '945000001842619', 2, 7, TRUE, FLOOR(EXTRACT(EPOCH FROM now()) * 1000), FALSE, FALSE, 650.48),
       ('event_1783770452508', '978000040086211', 3, 8, TRUE, FLOOR(EXTRACT(EPOCH FROM now()) * 1000), FALSE, FALSE, 669.12),
       ('event_1783770452508', '620098500124755', 4, 9, TRUE, FLOOR(EXTRACT(EPOCH FROM now()) * 1000), FALSE, FALSE, 641.95),
