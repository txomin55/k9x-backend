...
VALUES ('event_1783770421009', 'OBDX', 'OBDX.FCI_GRADE_1.V0', 'AVG', 'Classe 1', 'k9x.support@gmail.com',
        'stage_1783770388394', NULL, 1783770635598, 1783770428198, NULL, ARRAY []::VARCHAR[], 237, FALSE),
       ('event_1783770430523', 'OBDX', 'OBDX.FCI_GRADE_2.V0', 'AVG', 'Classe 2', 'k9x.support@gmail.com',
        'stage_1783770388394', NULL, 1783770623129, 1783770439363, NULL, ARRAY []::VARCHAR[], 437, FALSE),
       ('event_1783770452508', 'OBDX', 'OBDX.FCI_GRADE_3.V0', 'AVG', 'Classe 3', 'k9x.support@gmail.com',
        'stage_1783770388394', NULL, 1783770606029, 1783770460401, NULL, ARRAY []::VARCHAR[], 685, TRUE),
       ('event_1783770408793', 'OBDX', 'OBDX.CPC_COBS.V0', 'AVG', 'COBS', 'k9x.support@gmail.com',
        'stage_1783770388394', NULL, 1783770506599, 1783770415880, NULL, ARRAY []::VARCHAR[], 136, FALSE);
