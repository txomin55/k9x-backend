...
public class SaveObdxEventSnapshotJooqAdapter implements SaveObdxEventSnapshotPersistencePort {

    private final DSLContext dsl;
    private final ObjectMapper objectMapper;

    public SaveObdxEventSnapshotJooqAdapter(DSLContext dsl, ObjectMapper objectMapper) {
        this.dsl = dsl;
