...
public class CreateDogJooqAdapter implements CreateDogPersistencePort {
    ...
    /**
     * Upsert on the identification primary key: a brand-new identification is inserted, while an identification that already belongs to a
     * soft-deleted dog reactivates that row (deleted_at = null) with the new data. Active identification/origin
    ...
    public void createDog(String identification, String name, String image, String breed, String origin,
        ...
        dsl.insertInto(Tables.DOGS)
                .set(Tables.DOGS.IDENTIFICATION, identification)
                ...
                .onConflict(Tables.DOGS.IDENTIFICATION)
                .doUpdate()
                .set(Tables.DOGS.NAME, name)
                .set(Tables.DOGS.IMAGE, image)
                .set(Tables.DOGS.BREED, breed)
