...
class ObdxConfigurationGradeTest {
    ...
    void resolves_the_grade_of_a_spanish_spelled_configuration() {
        assertEquals("1", ObdxConfigurationGrade.resolve("OBDX.RSCE_GRADO_1.V2022"));
    }

    /** NKK numbers its classes too, spelled KLASSE in Norwegian. */
    @Test
    void resolves_the_grade_of_a_norwegian_spelled_configuration() {
        assertEquals("1", ObdxConfigurationGrade.resolve("OBDX.NKN_KLASSE_1.V2022"));
        assertEquals("3", ObdxConfigurationGrade.resolve("OBDX.NKN_KLASSE_3.V2022"));
    }
    ...
    void resolves_the_grade_of_a_swedish_spelled_configuration() {
        assertEquals("1", ObdxConfigurationGrade.resolve("OBDX.SKK_KLASS_1.V2022"));
        assertEquals("2", ObdxConfigurationGrade.resolve("OBDX.SKK_KLASS_2.V2022"));
    }
    ...
    void has_no_grade_for_configurations_without_a_number() {
        ...
        assertNull(ObdxConfigurationGrade.resolve("OBDX.CPC_COBS.V2022"));
        assertNull(ObdxConfigurationGrade.resolve("OBDX.SPKL_ALO.V2022"));
    }
