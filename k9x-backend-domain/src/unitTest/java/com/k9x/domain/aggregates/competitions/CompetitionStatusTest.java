...
class CompetitionStatusTest {
    ...
    private static Competition competition(Long deletedAt, List<Stage> stages) {
        return new Competition("c1", "WC", "creator", "Org", "ES", "desc", "addr", null, null, 0L, 0L, deletedAt, stages);
    }

    private static Stage stage(long dateFrom, long dateTo, Long deletedAt) {
        return new Stage("s", "Stage", "c1", "creator", dateFrom, dateTo, 0L, 0L, deletedAt, List.of());
    }
