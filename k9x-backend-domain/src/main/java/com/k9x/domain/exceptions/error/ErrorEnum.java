...
public enum ErrorEnum {
    ...
    MULTIPLE_MAIN_JUDGES_IN_EVENT("error.multiple_main_judges_in_event"),
    COMPETITOR_NOT_FOUND_IN_EVENT("error.competitor_not_found_in_event"),
    EVENT_PROOF_NOT_SUPPORTED("error.event_proof_not_supported"),
